...
public class BM25_Algorithm {

    /** The constant k_1.*/
    private double k_1 = 1.2d;

    /** The constant k_2.*/
    private double k_2 = 100d;

    /** The parameter b.*/
    private double b;

    /** A default constructor.*/
    public BM25_Algorithm() {
            super();
            b = 0.75d;
    }
    ...
    public final String getInfo() {
            return "BM25 >> b="+b +", k_1=" + k_1 +", k_2=" + k_2;
    }
    ...
    public final double score(double tf, 
            ...
            weight = weight * ( ((k_2 + 1) * queryFrequency) / (k_2 + queryFrequency) );	//second part
